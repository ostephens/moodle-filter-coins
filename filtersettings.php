...
if ($ADMIN->fulltree) {
	...
	$settings->add(new admin_setting_configtext('filter_coins_baseurl',
        ...
        get_string('configbaseurl', 'filter_coins'), 'http://worldcatlibraries.org/registry/gateway', PARAM_NOTAGS));
	...
	$settings->add(new admin_setting_configtext('filter_coins_linkalttext',
